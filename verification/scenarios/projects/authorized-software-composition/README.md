...
Identifiers introduced under #131 remain experimental. Open architecture exploration
#132 owns namespace/schema-identifier conventions; these spellings establish no
naming precedent, compatibility alias or contract freeze.
