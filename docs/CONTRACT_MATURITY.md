...
member attribution, and frozen-plan validation. [ADR 0020](adr/0020-governed-policy-composition-without-sealing.md)
amends the prior fixed/sealed closure: fixed owns its base but does not bar valid
tailoring or compatible independently applicable contributions; sealing is removed.
Atomic default semantics remain intact. The coordinated in-place
