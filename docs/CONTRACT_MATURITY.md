...
default remain intact. The coordinated in-place schema/runtime/frozen-plan/Coverage
cutover changes no artifact version or identity algorithm and introduces no
compatibility reader or freeze.
