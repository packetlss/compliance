...
- [ADR 0012 — Explicit policy-parameter resolution and policy-owned evidence freshness](0012-explicit-policy-parameter-resolution.md)
- [ADR 0016 — Closed-world company policy assessment](0016-closed-world-policy-assessment.md) — supersedes ADRs 0013–0015; bounded closed-world assessment.
