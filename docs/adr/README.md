...
- [ADR 0007 — Separate actual composition provenance from expected enforcement](0007-unified-actual-and-expected-composition-provenance.md) — accepted result/plan ownership refinement routed to [#90](https://github.com/packetlss/compliance/issues/90).
