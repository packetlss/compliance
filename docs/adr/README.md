...
- [ADR 0012 — Explicit policy-parameter resolution and policy-owned evidence freshness](0012-explicit-policy-parameter-resolution.md) — parameter ownership/representation superseded by ADR 0024 Tranche B under #201.
