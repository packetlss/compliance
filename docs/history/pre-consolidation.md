...
| verification-only policy source | `packetlss-labs/compliance-verification-policy` | `18e2b91751c53f5e78fd73edb552b7a4c32c762c` | staged by `packetlss/compliance#10`; destination PR pending assignment; historical source remains authoritative until merge and cutover |
