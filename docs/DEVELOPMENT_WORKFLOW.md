...
Runs the canonical deterministic composed scenario/feature suite from a temporary non-Git assembly of explicit destination roots. It owns all 24 retained public CLI leaves and 19 retained domain features.
