...
- Minimal valid producer documents for all 13 active evidence types, including
  macOS and the distinct organizational risk-assessment and training observations, plus typed optional AWS security-contact
