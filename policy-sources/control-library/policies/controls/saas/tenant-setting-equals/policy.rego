package compliance.controls.saas.tenant_setting_equals
...
outcome := {
	...
	"status": "fail",
	"reason": sprintf("SaaS setting %s.%s is %v; expected %v", [section, setting, observed, expected]),
	"expected": {section: {setting: expected}},
	"observed": {section: {setting: observed}},
} if {
	observed != expected
	...
	"status": "pass",
	"reason": sprintf("SaaS setting %s.%s is %v", [section, setting, expected]),
	"expected": {section: {setting: expected}},
	"observed": {section: {setting: observed}},
}
