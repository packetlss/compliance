...
- **Framework accounting is project governance, not policy composition.** The
  implemented experimental `FrameworkObligationDeclaration` from system ADR 0021 owns a closed,
